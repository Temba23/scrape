...
from .views import login, signout, register, home, symbol, alert, base, view_alerts, del_alerts, create_watchlist, view_watchlist, del_watchlist
...
urlpatterns = [
    ...
    path('delwatchlist/',del_watchlist, name="del_watchlist"),
]